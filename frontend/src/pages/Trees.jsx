  ...
  return (
    <div>
      ...
      <div className='flex justify-center flex-wrap gap-10 pt-20 pb-4 md:pb-8 lg:pb-12 xl:p-16'>
        ...
        >
          <div className='flex flex-row justify-center px-4 text-center'>
            <div className='flex flex-row justify-center items-center'>
              ...
              />
              <div className='lg:text-4xl md:text-3xl text-2xl font-main-font text-primary tracking-wide border-light-green'>
        ...
        <div className='relative w-full mx-auto p-4 md:p-8 lg:p-12 xl:p-16 border-light-green flex flex-col justify-center flex-wrap gap-10 pt-20 pb-10'>
