    ...
    <div className='bg-bg-page-color'>
      ...
      <div className='container mx-auto p-3'>
        <div className='bg-white mt-2 rounded-lg py-3 px-5'>
          <Link
            to='/news'
            className='flex items-center w-max border-2 justify-center gap-1 px-8 h-max py-1  bg-light-green text-font-family-color rounded-[10px] hover:bg-lighter-primary transition duration-4000 ease-linear'
          ...
          {article && (
            <div className='flex flex-col lg:flex-row'>
              <div className='w-full lg:w-1/4 p-4'>
                ...
                <Link
                  to='/news'
                  className='flex items-center w-max border-2 justify-center gap-1 px-3 h-max py-1  bg-light-green text-font-family-color rounded-[10px] hover:bg-lighter-primary transition duration-4000 ease-linear'
                >
