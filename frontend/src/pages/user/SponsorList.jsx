      ...
      {cartProducts.map(product => (
        ...
        >
          ...
          <div className='w-full flex flex-col items-center pb-2'>
            <div className='hidden md:flex flex-row items-center md:self-start md:pl-6 text-xl font-main-font text-primary tracking-wide p-2'>
              <img
                src={treeIcon1}
                alt='Tree Icon'
            ...
            <Link to={`/trees/${product._id}`}>
              <div className='flex flex-col-reverse items-center md:flex-row '>
                ...
                />
                <div
                  className={`text-2xl sm:text-[1rem] font-main-font sm:font-general-font text-primary sm:text-dark-gray text-center sm:text-start`}
                >
                  {product.name}
                </div>
              </div>
          ...
          <div className='w-full flex flex-col items-start'>
            <div className='hidden sm:flex-1 sm:block flex-row justify-center items-center text-xl font-main-font text-primary tracking-wide pb-0 sm:pb-2'>
              Qty
            </div>
