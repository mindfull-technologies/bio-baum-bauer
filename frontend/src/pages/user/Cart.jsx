        ...
        <div className='lg:relative w-full lg:w-11/12 xl:w-[90%] 2xl:w-[80%] p-3 xs:p-2 md:p-4 lg:p-8 bg-white rounded-lg lg:z-0 shadow-lg mt-[2px] lg:mt-[100px] xl:mt-[120px]'>
          <div className='flex justify-between items-center'>
            ...
            {cartProducts.length > 0 && (
              <Link
                to='/checkout'
                className='flex items-center justify-center h-max gap-1 text-[1.2rem] md:text-[1.4rem] lg:text-[1.7rem] bg-darker-secondary text-white-color px-5 py-2 lg:px-8 rounded-full hover:bg-lighter-secondary hover:text-primary transition duration-4000 ease-linear'
              >
            ...
            {cartProducts.length > 0 && (
              <div className='w-[100%] lg:w-[30%]'>
                <div className='flex flex-col gap-[0.4rem] bg-light-gray lg:bg-none rounded-md mt-4 xs:p-2 p-4'>
                  ...
                  <Link
                    to='/checkout'
                    className='flex items-center justify-center gap-1 text-center w-full my-2 px-4 py-2 bg-darker-secondary text-white-color rounded-[10px] hover:bg-lighter-secondary hover:text-primary transition duration-4000 ease-linear'
            ...
            {cartProducts.length > 0 && (
              <div className='w-full lg:w-[70%] flex flex-col items-center justify-start gap-9 rounded-md mt-6 lg:mt-4 py-3 md:px-2 lg:border-l-4'>
                {cartProducts.map(product => (
                  ...
                  >
                    ...
                    <div className='w-full sm:w-[25%] flex flex-col items-center sm:items-start'>
                      <div className='hidden sm:flex flex-row items-center text-xl font-main-font text-primary tracking-wide pb-2'>
                        <img
                          src={treeIcon}
                          alt='Tree Icon'
                      ...
                      <Link to={`/trees/${product._id}`}>
                        <div className='flex items-center flex-col-reverse sm:flex-row'>
                          ...
                          />
                          <div
                            className={`text-2xl sm:text-[1rem] font-main-font sm:font-general-font text-primary sm:text-dark-gray text-center sm:text-start font-bold`}
                          >
                            {product.name}
                          </div>
                        </div>
                    ...
                    <div className='w-full sm:w-[25%] flex flex-col items-start pt-0'>
                      <div className='hidden sm:flex text-xl font-main-font text-primary tracking-wide pb-2'>
                        Price
                      </div>
                ...
                <div className='flex w-full mx-auto'>
                  <button
                    className='flex items-center justify-center gap-1 text-center w-full my-2 px-4 py-2 bg-lighter-secondary text-primary rounded-[10px] hover:bg-darker-secondary hover:text-white-color transition duration-4000 ease-linear mb-6 sm:mb-0'
