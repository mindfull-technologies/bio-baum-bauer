        ...
        <div className=' p-4'>
          <div className='flex items-center mb-6 justify-between flex-wrap'>
            <div className='flex items-center justify-start'>
              ...
              />
              <h3 className='text-2xl text-accent font-main-font tracking-wide border-b-2 border-primary inline-block'>
                {name}
              </h3>
            </div>
          ...
          <div className='mt-2 mb-1 flex justify-start'>
            <Link
              to={`/trees/${id}`}
              className='flex items-center justify-center text-center border-2 w-full px-4 py-2 bg-primary text-stone rounded-[10px] hover:bg-primary-light hover:border-2 transition duration-4000 ease-linear mt-4 sm:mt-0'
            >
