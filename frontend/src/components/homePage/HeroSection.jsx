    ...
    >
      ...
      <div className='w-[90%] md:w-[80%] lg:w-[60%] xl:w-[40%] m-auto'>
        <div className='flex flex-col justify-center items-center mt-8'>
          ...
          <Link
            to='/trees'
            className='mx-auto flex items-center gap-2 px-8 py-2 mt-4 bg-light-green text-font-family-color rounded-[10px] hover:bg-lighter-primary transition duration-4000 ease-linear'
